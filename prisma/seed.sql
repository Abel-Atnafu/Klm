...
VALUES (
  1,
  'My Dearest Love',
  'From the very first moment I saw you, something shifted inside me — quietly, the way dawn arrives before you notice the sky has changed. You were simply there, and yet everything felt different.
